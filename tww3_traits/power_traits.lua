--------------------------------------------------------------------------------
-- power_traits.lua  -  lean "base game only" power set (230 traits)
--
...
local TRAITS = {
    -- ---- Survivability ----
    { "wh2_main_trait_casualties", 3 },  -- Wades Through Gore
    ...
    { "wh_main_trait_all_personality_all_hates_dwarfs", 1 },  -- Hates Dwarfs
    { "wh_main_trait_all_personality_all_hates_greenskins", 1 },  -- Hates Greenskins
    -- ---- Attack ----
    ...
    { "wh2_main_trait_wins", 3 },  -- Legendary
    ...
    -- ---- Army ----
    { "wh2_main_trait_agent_action_block_army", 1 },  -- {{tr:agent_action_block_army_name}}
    { "wh2_main_trait_agent_target_fail", 3 },  -- Golden
    { "wh2_main_trait_agent_target_success", 3 },  -- Doomed
    ...
    { "wh2_main_trait_defending_victory", 3 },  -- Impenetrable Wall
    { "wh2_main_trait_far_from_capital", 1 },  -- Seasoned Campaigner
    { "wh2_main_trait_lone_wolf", 3 },  -- Lone Wolf
    { "wh2_main_trait_razing", 3 },  -- Carnage Incarnate
    ...
    { "wh2_main_trait_siege_victory", 3 },  -- Adept Besieger
    { "wh2_main_trait_skv_flayed_tail", 1 },  -- Flayed Tail
    { "wh2_main_trait_stance_ambushing", 1 },  -- Ambuscader
    ...
    { "wh2_main_trait_stance_recruiting", 1 },  -- Musterer
    { "wh2_main_trait_stance_stalking", 1 },  -- Hunter
    { "wh2_main_trait_stance_tunneling", 1 },  -- Tunneller
    { "wh2_main_trait_wins_against_beastmen", 1 },  -- Beast Master
    { "wh2_main_trait_wins_against_cathay", 1 },  -- Victory Over Cathay
    { "wh2_main_trait_wins_against_chaos", 1 },  -- Chaos Breaker
    { "wh2_main_trait_wins_against_chaos_dwarfs", 1 },  -- Dawi-Zharr Doom
    { "wh2_main_trait_wins_against_daemons", 1 },  -- Victory Over Daemons
    { "wh2_main_trait_wins_against_dark_elves", 1 },  -- Druchii Destroyer
    { "wh2_main_trait_wins_against_dwarfs", 1 },  -- Dwarfen Dread
    { "wh2_main_trait_wins_against_greenskins", 1 },  -- Orcsbane
    { "wh2_main_trait_wins_against_high_elves", 1 },  -- Asur Annihilator
    { "wh2_main_trait_wins_against_humans", 1 },  -- Scourge of Mankind
    { "wh2_main_trait_wins_against_khorne", 1 },  -- Victory Over Khorne
    { "wh2_main_trait_wins_against_kislev", 1 },  -- Victory Over Kislev
    { "wh2_main_trait_wins_against_lizardmen", 1 },  -- Reptilian Ravager
    { "wh2_main_trait_wins_against_nurgle", 1 },  -- Victory Over Nurgle
    { "wh2_main_trait_wins_against_ogre_kingdoms", 1 },  -- Victory Over the Ogres
    { "wh2_main_trait_wins_against_rogue_armies", 1 },  -- Rogue Hunter
    { "wh2_main_trait_wins_against_skaven", 1 },  -- Rat Catcher
    { "wh2_main_trait_wins_against_slaanesh", 1 },  -- Victory Over Slaanesh
    { "wh2_main_trait_wins_against_tomb_kings", 1 },  -- Tomb Raider
    { "wh2_main_trait_wins_against_tzeentch", 1 },  -- Victory Over Tzeentch
    { "wh2_main_trait_wins_against_vampire_coast", 1 },  -- Pirate Hunter
    { "wh2_main_trait_wins_against_vampires", 1 },  -- Vampire Slayer
    { "wh2_main_trait_wins_against_wood_elves", 1 },  -- Lumberjack
    { "wh2_main_trait_wins_at_sea", 3 },  -- Master & Commander
    ...
    { "wh3_main_trait_corrupted_slaanesh", 1 },  -- Corrupted by Slaanesh
    ...
    { "wh_main_trait_general_personality_vmp_summon_creatures", 1 },  -- Summon Creatures of the Night
    -- ---- Economy ----
    { "wh2_main_trait_agent_action_hinder_replenishment", 1 },  -- {{tr:agent_action_hinder_replenishment_name}}
    { "wh2_main_trait_agent_action_steal_technology", 1 },  -- {{tr:agent_action_steal_technology_name}}
